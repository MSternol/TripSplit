// Wspólny skrypt włączania/wyłączania sekcji formularzy (insurance/inspection)
// Używany też na Create/Edit – tutaj ładowany bezpiecznie (nic się nie stanie, gdy selektory nie istnieją)
...
(function () {
    ...
    function wire(toggleSelector, containerSelector) {
        ...
        if (checkbox) checkbox.addEventListener('change', () => setSectionState(checkbox, container));
    }
